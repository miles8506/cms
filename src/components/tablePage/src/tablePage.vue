<template>
  <div>
    <!-- for base-ui>table -->
    <data-table :userList="userList" v-bind="tablePageConfig">
...
export default defineComponent({
  ...
  setup() {
    ...
    const userList = computed(() => store.state.system.pageList);
    const pagesCount = computed(() => store.state.system.totalCount);
    return {
      userList,
      pagesCount
    };
